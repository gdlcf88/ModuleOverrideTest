...
namespace ModuleOverrideTest.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ModuleOverrideTestDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ModuleOverrideTestEfCoreEntityExtensionMappings to extend the IdentityUser entity
