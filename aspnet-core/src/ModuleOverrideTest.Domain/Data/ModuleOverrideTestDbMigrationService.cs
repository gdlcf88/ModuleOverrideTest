...
{
    public class ModuleOverrideTestDbMigrationService : ITransientDependency
    {
        public ILogger<ModuleOverrideTestDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IModuleOverrideTestDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public ModuleOverrideTestDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IModuleOverrideTestDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<ModuleOverrideTestDbMigrationService>.Instance;
        }
