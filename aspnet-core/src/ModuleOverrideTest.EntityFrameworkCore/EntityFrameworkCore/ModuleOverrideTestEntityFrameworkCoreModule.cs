...
namespace ModuleOverrideTest.EntityFrameworkCore
{
    ...
    public class ModuleOverrideTestEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<ModuleOverrideTestDbContext>(options =>
            {
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also ModuleOverrideTestMigrationsDbContextFactory for EF Core tooling. */
