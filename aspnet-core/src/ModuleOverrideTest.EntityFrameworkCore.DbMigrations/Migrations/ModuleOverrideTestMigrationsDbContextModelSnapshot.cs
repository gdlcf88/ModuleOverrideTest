...
{
    [DbContext(typeof(ModuleOverrideTestMigrationsDbContext))]
    partial class ModuleOverrideTestMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyAbp.SharedResources.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("SharedResourcesCategories");
                });

            modelBuilder.Entity("EasyAbp.SharedResources.CategoryOwners.CategoryOwner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SharedResourcesCategoryOwners");
                });

            modelBuilder.Entity("EasyAbp.SharedResources.ResourceItems.ResourceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("ResourceItemType")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("SharedResourcesResourceItems");
                });

            modelBuilder.Entity("EasyAbp.SharedResources.ResourceItems.ResourceItemContent", b =>
                {
                    ...
                    b.ToTable("SharedResourcesResourceItemContents");
                });

            modelBuilder.Entity("EasyAbp.SharedResources.ResourceUsers.ResourceUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SharedResourcesResourceUsers");
                });

            modelBuilder.Entity("EasyAbp.SharedResources.Resources.Resource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("PreviewMediaResources")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("SharedResourcesResources");
                });
            ...
            modelBuilder.Entity("EasyAbp.SharedResources.ResourceItems.ResourceItemContent", b =>
                {
                    b.HasOne("EasyAbp.SharedResources.ResourceItems.ResourceItem", null)
                        .WithOne("ResourceItemContent")
                        .HasForeignKey("EasyAbp.SharedResources.ResourceItems.ResourceItemContent", "ResourceItemId")
